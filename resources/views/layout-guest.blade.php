		...
		<nav id="sidebar" class="sidebar">
			...
			<div class="sidebar-content">
				<div class="sidebar-user">
					<img src="/spark/img/avatars/avatar.jpg" class="img-fluid rounded-circle mb-2" alt="Linda Miller" />
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item">
						...
						<ul id="documentation" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
							<li class="sidebar-item"><a class="sidebar-link" href="/spark/docs-getting-started.html">Getting Started</a></li>
							<li class="sidebar-item"><a class="sidebar-link" href="/spark/docs-plugins.html">Plugins</a></li>
							<li class="sidebar-item"><a class="sidebar-link" href="/spark/docs-changelog.html">Changelog</a></li>
						</ul>
					</li>
				</ul>
			</div>
					...
					<ul class="navbar-nav ms-auto">
						...
						<li class="nav-item dropdown ms-lg-2">
							...
							<div class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
								...
								<a class="dropdown-item" href="/spark/#"><i class="align-middle me-1 fas fa-fw fa-arrow-alt-circle-right"></i> Sign out</a>
							</div>
						</li>
					</ul>
				</div>
