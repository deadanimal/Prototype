        ...
        <div class="container-fluid">
            ...
            <div class="header">
                <h1 class="header-title">
                    {{ $product->name }} | <a href="/products/{{ $product->id }}/technical"
                        style="color: white">Technical</a>
                </h1>
